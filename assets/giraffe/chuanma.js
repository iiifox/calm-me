...
// @updateURL    https://iiifox.me/assets/giraffe/chuanma.js
// @downloadURL  https://iiifox.me/assets/giraffe/chuanma.js
...
(function () {
        ...
        const localStorage_VERIFICATION_RESP_KEY = 'verification_pay_response';

        // ---------------- 工具函数 ----------------
        function getCapturedResponse() {
            try {
                return localStorage.getItem(localStorage_VERIFICATION_RESP_KEY);
            } catch (e) {
                return null;
            }
        }
        ...
        function setCapturedResponse(response) {
            try {
                localStorage.setItem(localStorage_VERIFICATION_RESP_KEY, response);
                return true;
            } catch (e) {
                return false;
            }
        ...
        function clearCapturedResponse() {
            try {
                localStorage.removeItem(localStorage_VERIFICATION_RESP_KEY);
                return true;
            } catch (e) {
                return false;
            }
        ...
        function setupAPICapture() {
            ...
            function handleXhr(xhr) {
                ...
                if (ret === 2022) {
                    ...
                    showToast('✅ 已捕获验证码响应内容 (xhr)', "success");
                } else {
                    // 将长颈鹿风险验证替换为捕获的响应内容
                    if (ret === 1138) {
                ...
                if (isTargetUrl(url)) {
                    ...
                    try {
                        ...
                        if (ret === 2022) {
                            ...
                            showToast('✅ 已捕获证码响应内容 (fetch)', "success");
                        } else {
                            if (ret === 1138) {
                                const captured = getCapturedResponse();
                                if (captured) {
